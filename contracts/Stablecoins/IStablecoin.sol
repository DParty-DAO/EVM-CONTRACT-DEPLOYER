...
interface IStablecoin {
  ...
  function stablecoin_eth_oracle_address() external view returns (address);
  function stablecoin_info() external view returns (uint256, uint256, uint256, uint256, uint256, uint256, uint256, uint256);
  function stablecoin_pools(address ) external view returns (bool);
  function stablecoin_pools_array(uint256 ) external view returns (address);
  function stablecoin_price() external view returns (uint256);
  function stablecoin_step() external view returns (uint256);
  function has_address() external view returns (address);
  function has_eth_oracle_address() external view returns (address);
  ...
  function setStablecoinEthOracle(address _stablecoin_oracle_addr, address _weth_address ) external;
  function setHASAddress(address _has_address ) external;
  function setHASEthOracle(address _has_oracle_addr, address _weth_address ) external;
  function setFiatUSDOracle(address _fiat_usd_consumer_address) external;
  function setStablecoinStep(uint256 _new_step ) external;
  function setStablecoinManagerAddress(address stablecoin_manager_contract_address) external;
