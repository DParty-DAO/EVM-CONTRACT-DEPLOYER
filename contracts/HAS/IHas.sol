...
interface IHas {
  ...
  function HAS_DAO_min() external view returns(uint256);
  ...
  function setStablecoinManagerAddress(address stablecoin_factory_contract_address) external;
  function setHASMinDAO(uint256 min_HAS) external;
