...
contract TokenVesting {
    ...
    address public _HAS_contract_address;
    ERC20 HAS;
    ...
    function setHASAddress(address HAS_address) public {
        require(msg.sender == _owner, "must be set by the owner");
        _HAS_contract_address = HAS_address;
        HAS = ERC20(HAS_address);
    }
    ...
    function release() public {
        ...
        HAS.transfer(_beneficiary, unreleased);
    ...
    function revoke() public {
        ...
        uint256 balance = HAS.balanceOf(address(this));
    ...
    function recoverERC20(address tokenAddress, uint256 tokenAmount) external {
        ...
        require(tokenAddress != _HAS_contract_address, "Cannot withdraw the HAS through this function");
    ...
    function _vestedAmount() private view returns (uint256) {
        uint256 currentBalance = HAS.balanceOf(address(this));
